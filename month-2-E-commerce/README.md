...
| :---: | :--- | :---: | :---: | :---: | :---: |
| **Day 01** | Intro to Databases (SQL vs NoSQL & Relational Concepts) | [Day01_IntroToDatabases.md](file:///d:/anti/month-2-E-commerce/docs/Day01_IntroToDatabases.md) | [Day01_Homework.md](file:///d:/anti/month-2-E-commerce/activities/Day01_Homework.md) | [Day01_Homework_Guide.md](file:///d:/anti/month-2-E-commerce/activities/Day01_Homework_Guide.md) | ✅ Completed |
...
| **Day 03** | Prisma ORM Setup & Initial Schema | Pending | Pending | Pending | ⏳ Pending |
| **Day 04** | Data Modeling 1: Users, Profiles & Roles (1:1) | Pending | Pending | Pending | ⏳ Pending |
...
| **Day 08** | User Registration & Password Hashing (bcryptjs) | Pending | Pending | Pending | ⏳ Pending |
...
| **Day 11** | Product Management API (CRUD Endpoints) | Pending | Pending | Pending | ⏳ Pending |
| **Day 12** | Search, Filtering, Sorting & Pagination API | Pending | Pending | Pending | ⏳ Pending |
| **Day 13** | Product Image Uploads (Multer Middleware) | Pending | Pending | Pending | ⏳ Pending |
...
| **Day 19** | Security Hardening (Rate limiting, Helmet, CORS, Zod) | Pending | Pending | Pending | ⏳ Pending |
...
| **Day 22** | Intro to Redis & High-Performance Caching | Pending | Pending | Pending | ⏳ Pending |
